...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=AW0i9bIwRFP3oK2yA-QTzUIIWis6Rf0NvKbqrZHWkFrUzW8b0iul8D0HG6eE4NwTuLBVM06dP9RoXckx&currency=USD"></script>
<script>
    paypal.Buttons({
        onClick: function()  {
      ...
      createOrder: (data, actions) => {
        return actions.order.create({
          purchase_units: [{
            amount: {
              value: '0.01' //"{{$this->totalProductAmount}}" // Can also reference a variable or function
            }
          }]
        });
      },
