                    ...
                    <form action="{{url('admin/products/'.$product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="details-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="details-tab-pane" aria-selected="false">Product Price</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    <label class="pb-2">Small Description (500 Words)</label>
                            ...
                            <div class="tab-pane fade border p-3" id="seotag-tab-pane" role="tabpanel" aria-labelledby="seotag-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    <label class="pb-2">Meta Description</label>
                            ...
                            <div class="tab-pane fade border p-3" id="details-tab-pane" role="tabpanel" aria-labelledby="details-tab" tabindex="0">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="pb-2">Trending</label>
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="prod-color-tr">
                                                ...
                                                <td>
                                                    <button type="button" value="{{$prodcolor->id}}" class="deleteProductColorBtn btn btn-danger btn-sm text-white">Update</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
